function Position00 = importfile(filename, startRow, endRow)
%IMPORTFILE1 Import numeric data from a text file as a matrix.
%   POSITION00 = IMPORTFILE1(FILENAME) Reads data from text file FILENAME
%   for the default selection.
%
%   POSITION00 = IMPORTFILE1(FILENAME, STARTROW, ENDROW) Reads data from
%   rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   Position00 = importfile1('Position00.txt', 1, 25088);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2017/10/17 13:48:04
